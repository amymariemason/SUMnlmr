...
To illustrate the difference, we simulate data where a modifier 
varies the effect of `g` on `X` 
...
In this case, the ranked method `bx` varies across strata, while the interaction method produces more similar `bx` values. 
